...
export function AdminShell({ adminEmail, today, children }: Props) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div
        className={`flex-1 min-h-screen flex flex-col pt-14 lg:pt-0 transition-all duration-300 ease-in-out ${
          collapsed ? 'lg:ml-16' : 'lg:ml-60'
        }`}
      >
        {/* Sticky top header — desktop only */}
        <header className="hidden lg:flex sticky top-0 z-20 bg-white border-b border-slate-100 h-16 items-center px-6 gap-4 shrink-0 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
        ...
        {/* Mobile/tablet sub-header */}
        <div className="lg:hidden bg-white border-b border-slate-100 px-4 py-2.5 flex items-center gap-2">
