    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
      ...
      <div className="bg-white border-b border-[#E2E8F0]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-[#1E293B] mb-3">Privacy Policy</h1>
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-10">
        <div className="space-y-4">
          ...
          <Section num="1" title="Who We Are">
            <P>
              Datafyle (&ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;us&rdquo;) operates the AI document processing
              platform at datafyle.com. We are committed to protecting the personal data of our users.
          ...
          <Section num="3" title="How We Use Your Data">
            ...
            <div className="mt-5 p-4 bg-[#EFF6FF] rounded-lg border border-blue-100">
              <p className="text-sm text-[#1E293B] font-semibold">
                🔒 We never sell your data. Your documents are never used to train AI models.
                Your data is never shared with third parties except as described below.
              </p>
            </div>
          </Section>
          ...
          <Section num="7" title="Your Rights (GDPR / UK GDPR)">
            ...
            <p className="text-sm text-slate-600 mt-4">
              ...
              <a href="mailto:privacy@datafyle.com" className="text-[#2563EB] hover:underline font-medium">
          ...
          <Section num="9" title="Changes to This Policy">
            <P>
              We may update this policy periodically. Material changes will be notified via email to registered users
              at least 14 days before taking effect. Continued use of Datafyle after the effective date
          ...
          <Section num="10" title="Contact Us">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="mailto:privacy@datafyle.com" className="text-sm text-[#2563EB] hover:underline font-medium mt-1 inline-block">
                  privacy@datafyle.com
                </a>
              </div>
            </div>
